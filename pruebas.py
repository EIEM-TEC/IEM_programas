...
mallascsv = pd.read_csv("mallas_IEM.csv")
# acumulado = 0

# for index in mallascsv.index:
#     if mallascsv[mallascsv.index == index].Programa.item() == "EM":
#         acumulado = acumulado + mallascsv[mallascsv.index == index].Creditos.item()
#     if acumulado > 135:
#         mallascsv.loc[index, "Enfasis"] = "EN"

# print(mallascsv.tail())
# print(acumulado)


mallascsv.insert(3, 'Enfasis', "TC")




print(mallascsv.head())

mallascsv.to_csv("mallas_IEM.csv",index=False)
